...
/**
 * @component QuizReptiles => returns a quiz component for reptiles.
 */
...
const QuizReptiles = () => {
  return (
    <div className="flex justify-center items-center min-h-screen bg-orange-50 p-6">
      <QuizComponent questions={genericQuestions} type="reptile" />
    </div>
  );
};

export default QuizReptiles;
